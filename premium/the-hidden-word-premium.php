...
if ( ! function_exists( 'thw_premium_autoload' ) ) {
	...
	function thw_premium_autoload( $class ) {
		...
		$map = array(
			...
			'THW_Premium_AI_Study_Finder_Citations' => 'class-ai-study-finder-citations.php',
			'THW_Premium_AI_Study_Finder_Search'    => 'class-ai-study-finder-search.php',
			...
			'THW_Premium_Settings_App'          => 'class-premium-settings-app.php',
			...
			'THW_Premium_Votd_YouVersion'       => 'class-votd-youversion.php',
			'THW_Premium_Votd_Rest'             => 'class-votd-rest.php',
			...
			'THW_Premium_Bible_Study_Card'            => 'class-bible-study-card.php',
