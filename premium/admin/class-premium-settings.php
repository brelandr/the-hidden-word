					...
					<tr>
						...
						<td>
							<form method="post" action="options.php" style="margin-bottom:1em;">
								...
								<?php submit_button( __( 'Save app colors', 'hidden-word-bible-lessons' ), 'secondary', 'submit', false ); ?>
								<p class="description"><?php esc_html_e( 'Shown in the companion app after members select your church (logo + brand colors).', 'hidden-word-bible-lessons' ); ?></p>
							</form>
						</td>
					</tr>
					<tr>
